...
--18. Вывести пользователя у которых id равен 53betwe
select * from students 
where id = 53;
...
select name, created_on, id from students order by created_on;

--32. Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку убывания даты добавления пользоватлеля.
select name, created_on, id from students order by created_on desc;